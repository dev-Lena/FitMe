...
// 여기까지 로딩
        ...
        feedMain_adapter = new Feed_Main_Adapter(myreview_arrayList,this);
...
//                                return true;
                            ...
                            case R.id.action_share:
                                ...
                                // 텍스트 템플릿
                                String shop_url_link = myreview_arrayList.get(position).textView_shoppingmall_url; // 리뷰 아이템에서 사용자가 입력한 쇼핑몰 url
                                String shop_review_writer_link = myreview_arrayList.get(position).textView_nickname;
                                ...
                                KakaoLinkService.getInstance().sendDefault(Myreview_Activity.this, params, serverCallbackArgs, new ResponseCallback<KakaoLinkResponse>() {
                                    @Override
            ...
            public void onCommentClick(View v, int position) {
                Intent comment_intent = new Intent(Myreview_Activity.this, Comment_Activity.class);
...
//            }
        ...
        imageButton_back.setOnClickListener(new ImageView.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent register_intent = new Intent(Myreview_Activity.this, Mypage_Activity.class);
    ...
    public void remove(int position) {
        ...
        int feed_index = find_feed_arrayList(feedMain_adapter.getItem(position).getTextView_reviewcard_number());
