...
public class Size_Recommendation_skiny extends AppCompatActivity {
    /**
     * my fit 내 청바지 사이즈를 입력 하면 평균값을 구해 바지 스타일별(핏별 - ex 스키니진, 와이드진 등) 상세 사이즈(cm) 추천 (include 사용)
     * - 스키니핏 : 추천 청바지 상세 사이즈 (ex - 허리 70 cm 등) 보여주는 액티비티
     **/
...
//        set_text_again();
        ...
        setContentView(R.layout.activity_myfit_item_skiny);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Size_Recommendation_skiny.this, Feed_Main_Activity.class);
                        home_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(home_intent);//액티비티 띄우기
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Size_Recommendation_skiny.this, Review_searching_Activity.class);
                        search_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Size_Recommendation_skiny.this, Size_Recommendation_skiny.class);
                        write_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(write_intent);//액티비티 띄우기
                        break;
                    case R.id.action_shop:
                        Intent insight_intent = new Intent(Size_Recommendation_skiny.this, Naver_Search_Shop_Main.class);
                        insight_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(insight_intent);//액티비티 띄우기
                        break;
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Size_Recommendation_skiny.this, Mypage_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 5001 && resultCode == RESULT_OK) {
            ...
            Toast.makeText(Size_Recommendation_skiny.this, "사이즈 작성을 완료했습니다!", Toast.LENGTH_SHORT).show();
