...
public class Size_Recommendation_ItemData {
...
//text_view_fitname,image_view, textView_waist,textView_sero,textView_bugGi,textView_long,textView_ancle
    ...
    public Size_Recommendation_ItemData(String text_view_fitname, String textView_waist, String textView_sero, String textView_bugGi, String textView_long, String image_view, String textView_ancle) {
        this.text_view_fitname = text_view_fitname;
        this.image_view = image_view;
        this.textView_waist = textView_waist;
        this.textView_sero = textView_sero;
