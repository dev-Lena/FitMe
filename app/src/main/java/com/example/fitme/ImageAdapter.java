...
public interface OnItemClickListener {
    ...
    public ImageAdapter(Context context, ArrayList<ImageSearchItemData> exampleList) {
        mContext = context;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        String imageUrl = imageSearchItemData.getImageUrl();
        String creatorName = imageSearchItemData.getCreator();
        int likeCount = imageSearchItemData.getLikeCount();
