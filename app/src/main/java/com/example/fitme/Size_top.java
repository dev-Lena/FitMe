...
// 검색 버튼 -> 검색 결과 화면 이동
        ...
        imageButton_review_register.setOnClickListener(new ImageView.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("Write_review_Activity", "shoppinmall : " +shoppinmall);
                Log.e("Write_review_Activity", "detailedReview : " +detailedReview);
...
//
//
//                Intent intent = new Intent(Write_review_Activity.this, review_card.class);
...
////
//
//                Log.e("Write_review_Activity", "url : " +url);
//                Log.e("Write_review_Activity", "detailed_review : " +detailed_review);
////
//                startActivity(intent);
//            }
//        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Size_top.this, Feed_Main_Activity.class);
                        startActivity(home_intent);//액티비티 띄우기
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Size_top.this, Review_searching_Activity.class);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Size_top.this, Size_Recommendation_Activity.class);
                    ...
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Size_top.this, Mypage_Activity.class);
