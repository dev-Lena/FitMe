...
public class Review_searching_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Feed_Main_Adapter feedMain_adapter;
...
//    txt_main의 값은 txt_main.getText().toString()을 이용하면 됩니다.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("Review_searching_Activity","onCreate");
...
//                Intent intent = new Intent(Review_searching_Activity.this, Review_searching_Result.class);
//                intent.putExtra("HashTag", HashTag);
//                Log.e("Review_searching_Activity", "HashTag : " +HashTag);
//                startActivity(intent);
////                Intent register_intent = new Intent(Review_searching_Activity.this, Review_searching_Result.class);
...
//            @Override
//            public void onClick(View view) {
//                Intent register_intent = new Intent(Review_searching_Activity.this, hashtag.class);
//                startActivity(register_intent); //액티비티 이동
//
//            }
//        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Review_searching_Activity.this, Feed_Main_Activity.class);
                        home_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(home_intent);//액티비티 띄우기
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Review_searching_Activity.this, Review_searching_Activity.class);
                        search_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Review_searching_Activity.this, Size_Recommendation_Activity.class);
                    ...
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Review_searching_Activity.this, Mypage_Activity.class);
    ...
    private void filter(String text) {  // 리사이클러뷰  filtering하는 메소드 -> 검색
        ArrayList<Feed_Main_ItemData> filteredList = new ArrayList<>();

        for (Feed_Main_ItemData item : arrayList) {
        ...
        feedMain_adapter.filterList(filteredList);
        Log.d("Review_searching_Activity 클래스","filter -> arrayList" + filteredList.size());
...
//        search_recyclerview.setHasFixedSize(true);
        ...
        feedMain_adapter = new Feed_Main_Adapter(arrayList, this);

        search_recyclerview.setLayoutManager(mLayoutManager);
        search_recyclerview.setAdapter(feedMain_adapter);
    }
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(this, Review_searching_Result.class);
    ...
    protected void onRestart() {
        super.onRestart();
        Log.e("Review_searching_Activity","onRestart");
        //액티비티가 중단되었다가 다시 시작
    }
    ...
    protected void onStart() {
        super.onStart();
        Log.e("Review_searching_Activity","onStart");
        //액티비티가 화면에 나타나기 시작
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.e("Review_searching_Activity","onResume");
    ...
    protected void onPause() {
        super.onPause();
        Log.e("Review_searching_Activity","onPause");
    ...
    protected void onStop() {
        super.onStop();
        Log.e("Review_searching_Activity","onStop");
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.e("Review_searching_Activity","onDestroy");
        //액티비티가 종료되려고 합니다.
    }
