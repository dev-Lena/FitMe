...
public class Size_Recommendation_Activity extends AppCompatActivity {
    /**
     * my fit 내 청바지 사이즈를 입력 하면 평균값을 구해 바지 스타일별(핏별 - ex 스키니진, 와이드진 등) 상세 사이즈(cm) 추천 (include 사용)
     * - 핏별 상세사이즈(cm) 추천 결과 보여주는 액티비티
     **/
...
//String feed_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myfit_result);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Size_Recommendation_Activity.this, Feed_Main_Activity.class);
                        home_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(home_intent);//액티비티 띄우기
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Size_Recommendation_Activity.this, Review_searching_Activity.class);
                        search_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Size_Recommendation_Activity.this, Size_Recommendation_Activity.class);
                        write_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(write_intent);//액티비티 띄우기
                        break;
                    case R.id.action_shop:
                        Intent insight_intent = new Intent(Size_Recommendation_Activity.this, Naver_Search_Shop_Main.class);
                        insight_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(insight_intent);//액티비티 띄우기
                        break;
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Size_Recommendation_Activity.this, Mypage_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 5001 && resultCode == RESULT_OK) {
            ...
            Toast.makeText(Size_Recommendation_Activity.this, "사이즈 작성을 완료했습니다!", Toast.LENGTH_SHORT).show();
...
//2번정보
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장1 : " + long1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장2 : " + long2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장3 : " + long3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 4: " + long4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장5: " + long5);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 토탈 기장 공식 : (waist1+waist2+waist3+waist4+waist5)/5" + total_waist);
...
//            textView_bugGi4.setText(String.valueOf(total_bugGi));
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 : " + long1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 2 : " + long2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 3 : " + long3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 4: " + long4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 5: " + long5);
