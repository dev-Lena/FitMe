...
//
//    TextView textView_mysize, textView_detailed_review_card, textView_shoppingmall_url;
//    Button button_hashtag1,button_hashtag2,button_hashtag3,button_hashtag4 ;
...
//        button_hashtag1 = (Button)findViewById(R.id.button_hashtag1);
//        imageView_reviewcard_img1 = (ImageView)findViewById (R.id.imageView_reviewcard_img1);
//        button_hashtag2 = (Button)findViewById(R.id.button_hashtag2);
//        button_hashtag3 = (Button)findViewById(R.id.button_hashtag3);
//        button_hashtag4 = (Button)findViewById(R.id.button_hashtag4);
//
//
//        // 검색 화면에서 검색어 데이터 받기
//        textView_detailed_review_card = (TextView)findViewById(R.id.textView_detailed_review_card);
