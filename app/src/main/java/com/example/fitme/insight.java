...
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                    ...
                    case R.id.action_write_review :
                        Intent write_intent = new Intent(insight.this,review_category.class);
                        startActivity(write_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent insight_intent = new Intent(insight.this,insight.class);
                        startActivity(insight_intent);//액티비티 띄우기
                        break;
                    case R.id.action_mycloset :
                        Intent mycloset_intent = new Intent(insight.this,my_closet.class);
