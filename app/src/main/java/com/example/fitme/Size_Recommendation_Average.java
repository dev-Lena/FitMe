...
public class Size_Recommendation_Average extends AppCompatActivity {
    /**
     * my fit 내 청바지 사이즈를 입력 하면 평균값을 구해 바지 스타일별(핏별 - ex 스키니진, 와이드진 등) 상세 사이즈(cm) 추천 (include 사용)
     * - 사용자가 입력한 청바지 사이즈들의 평균값을 보여주는 액티비티
     **/
...
//String feed_id;
    ...
    textView_waist,textView_sero, textView_hip, textView_bugGi, textView_long, textView_ancle,
    textView_waist1,textView_sero1, textView_hip1, textView_bugGi1, textView_long1, textView_ancle1,
    textView_waist2,textView_sero2, textView_hip2, textView_bugGi2, textView_long2, textView_ancle2,
    textView_waist3,textView_sero3, textView_hip3, textView_bugGi3, textView_long3, textView_ancle3,
    textView_waist4,textView_sero4, textView_hip4, textView_bugGi4, textView_long4, textView_ancle4;



    ImageButton imageButton_back;
    ImageButton imageButton_follow_back;
    Button  button_myfit_edit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myfit_average);
        ...
        Log.e("[Size_Recommendation_Average] 로그인한 회원 정보가 있는 쉐어드에서", " 현재 로그인한 유저의 닉네임 넣기 : " + feed_nick);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Size_Recommendation_Average.this, Feed_Main_Activity.class);
                        home_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(home_intent);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Size_Recommendation_Average.this, Review_searching_Activity.class);
                        search_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Size_Recommendation_Average.this, Size_Recommendation_Average.class);
                        write_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(write_intent);//액티비티 띄우기
                        break;
                    case R.id.action_shop:
                        Intent insight_intent = new Intent(Size_Recommendation_Average.this, Naver_Search_Shop_Main.class);
                        insight_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(insight_intent);//액티비티 띄우기
                        break;
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Size_Recommendation_Average.this, Mypage_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 5001 && resultCode == RESULT_OK) {
            ...
            Toast.makeText(Size_Recommendation_Average.this, "사이즈 작성을 완료했습니다!", Toast.LENGTH_SHORT).show();
...
//2번정보
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허리 : " + waist1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허리2 : " + waist2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허리3 : " + waist3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허리 4: " + waist4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허리 5: " + waist5);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 토탈 허리 공식 : (waist+waist2+waist3+waist4+waist5)/5;" + total_waist);
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑위 : " + sero1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑위2 : " + sero2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑위3 : " + sero3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑위 4: " + sero4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑위 5: " + sero5);
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 엉덩이 : " + hip1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 엉덩이 2 : " + hip2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 엉덩이 3 : " + hip3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 엉덩이 4: " + hip4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 엉덩이 5: " + hip5);
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허벅지 : " + bugGi1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허벅지 2 : " + bugGi2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허벅지 3 : " + bugGi3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허벅지 4: " + bugGi4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 허벅지 5: " + bugGi5);
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 : " + longlong1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 2 : " + longlong2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 3 : " + longlong3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 4: " + longlong4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 기장 5: " + longlong5);
            ...
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑단 : " + ancle1);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑단 2 : " + ancle2);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑단 3 : " + ancle3);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑단 4: " + ancle4);
            Log.e("[Size_Recommendation_Activity] sizeShared 쉐어드에서", " 밑단 5: " + ancle5);
