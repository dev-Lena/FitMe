...
// done 버튼 -> 리뷰를 등록하는 버튼
        ...
        imageButton_review_register.setOnClickListener(new ImageView.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent register_intent = new Intent(Size_dress.this, Feed_Main_Activity.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Size_dress.this, Feed_Main_Activity.class);
                        startActivity(home_intent);//액티비티 띄우기
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Size_dress.this, Review_searching_Activity.class);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Size_dress.this, Size_Recommendation_Activity.class);
                        startActivity(write_intent);//액티비티 띄우기
                        break;
                    case R.id.action_notification :
                        Intent insight_intent = new Intent(Size_dress.this, Image_Searching.class);
                        startActivity(insight_intent);//액티비티 띄우기
                        break;
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Size_dress.this, Mypage_Activity.class);
