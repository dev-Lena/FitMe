            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home :
                        Intent home_intent = new Intent(Size_Recommendation_wide.this, Feed_Main_Activity.class);
                        home_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(home_intent);//액티비티 띄우기
//                        startActivityForResult(intent,sub);//액티비티 띄우기
                        break;
                    case R.id.action_search :
                        Intent search_intent = new Intent(Size_Recommendation_wide.this, Review_searching_Activity.class);
                        search_intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(search_intent);//액티비티 띄우기
                        break;
                    case R.id.action_insight :
                        Intent write_intent = new Intent(Size_Recommendation_wide.this, Size_Recommendation_wide.class);
                    ...
                    case R.id.action_mypage :
                        Intent mycloset_intent = new Intent(Size_Recommendation_wide.this, Mypage_Activity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 5001 && resultCode == RESULT_OK) {
            ...
            Toast.makeText(Size_Recommendation_wide.this, "사이즈 작성을 완료했습니다!", Toast.LENGTH_SHORT).show();
